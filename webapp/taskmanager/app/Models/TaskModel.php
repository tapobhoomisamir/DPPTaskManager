...
class TaskModel extends Model
{
    ...
    protected $allowedFields    = ['project_id','user_id','title','description','department_id','assign_by','due_date','tasktype_id','workweek_id','status','priority','start_date','due_date','status','completed_date','expense','time_taken'];
